...
#     fn = r"D:\work\dewnr\logging_software\las_reader\tests\examples\encoding_cp437.las"
...
#     fn = r"D:\work\dewnr\logging_software\las_reader\tests\examples\encoding_utf8.las"
#     l = las_reader.read(fn, autodetect_encoding=True)
#     assert l._text == codecs.open(fn, mode="r", encoding="utf8").read()

# def test_autodetect_win1252():
#     fn = r"D:\work\dewnr\logging_software\las_reader\tests\examples\encoding_win1252.las"
#     l = las_reader.read(fn, autodetect_encoding=True)
